...
namespace O2S_InsuranceExpertise.Base
{
    ...
    {
        static string key = O2S_InsuranceExpertise.Base.KeyTrongPhanMem.MaHoaVaGiaiMa_key;
        /// <summary>
        ...
        internal static string Encrypt(string toEncrypt, bool useHashing)
        {
            ...
            {
                return "";
                O2S_InsuranceExpertise.Base.Logging.Warn("Ham ma hoa " + ex.ToString());
            }
        }
        /// <summary>
        /// Giải mã 1 chuỗi
        ...
        internal static string Decrypt(string cipherString, bool useHashing)
        {
            ...
            {
                return "";
                O2S_InsuranceExpertise.Base.Logging.Warn("Ham giai ma " + ex.ToString());
            }
        }
