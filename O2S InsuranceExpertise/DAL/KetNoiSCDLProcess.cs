...
namespace O2S_InsuranceExpertise.DAL
{
    internal static class KetNoiSCDLProcess
    {
        ...
        internal static bool CapNhatCoSoDuLieu()
        {
            ...
            {
                O2S_InsuranceExpertise.Base.Logging.Error("Lỗi Update DB" + ex.ToString());
            }
            return result;
        }
        ...
        private static bool CreateMrdServiceref()
        {
            ...
            {
                O2S_InsuranceExpertise.Base.Logging.Error("Lỗi CreateMrdServiceref" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableTblPermission()
        {
            ...
            {
                O2S_InsuranceExpertise.Base.Logging.Error("Lỗi CreateTableTblPermission" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableTblDepartment()
        {
            ...
            {
                O2S_InsuranceExpertise.Base.Logging.Error("Lỗi CreateTableTblDepartment" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableTblLog()
        {
            ...
            try
            {
                string sql_tbllog = "CREATE TABLE IF NOT EXISTS ie_tbllog (logid serial NOT NULL,loguser text, logvalue text,ipaddress text,computername text,softversion text,logtime timestamp without time zone,CONSTRAINT tools_tbllog_pkey PRIMARY KEY (logid));";
            ...
            {
                O2S_InsuranceExpertise.Base.Logging.Error("Lỗi CreateTableTblLog" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableOption()
        {
            ...
            try
            {
                string sqloption = "CREATE TABLE IF NOT EXISTS ie_option(toolsoptionid serial NOT NULL, toolsoptioncode text, toolsoptionname text, toolsoptionvalue text, toolsoptionnote text, toolsoptionlook integer, toolsoptiondate timestamp without time zone, toolsoptioncreateuser text, CONSTRAINT tools_option_pkey PRIMARY KEY (toolsoptionid));";
            ...
            {
                O2S_InsuranceExpertise.Base.Logging.Error("Lỗi CreateTableOption" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableUserDepartmentgroup()
        {
            ...
            {
                O2S_InsuranceExpertise.Base.Logging.Error("Lỗi CreateTableUserDepartmentgroup" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableVersion()
        {
            ...
            try
            {
                string sqloption = "CREATE TABLE IF NOT EXISTS ie_version (versionid serial NOT NULL, appversion text, app_link text,  app_type integer, updateapp bytea, appsize integer, sqlversion text, updatesql bytea, sqlsize integer, sync_flag integer,  update_flag integer,  CONSTRAINT tools_version_pkey PRIMARY KEY (versionid));   ";
                if (condb.ExecuteNonQuery_HSBA(sqloption))
                {
                    result = true;
                }
            ...
            {
                O2S_InsuranceExpertise.Base.Logging.Error("Lỗi CreateTableSersion" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableLicense()
        {
            ...
            try
            {
                string sql_tbltools_license = "CREATE TABLE IF NOT EXISTS ie_license (licenseid serial NOT NULL, datakey text, licensekey text, CONSTRAINT tools_license_pkey PRIMARY KEY (licenseid));";
            ...
            {
                O2S_InsuranceExpertise.Base.Logging.Error("Lỗi CreateTableLicense" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableTblNhanVien()
        {
            ...
            {
                O2S_InsuranceExpertise.Base.Logging.Error("Lỗi CreateTableTblNhanVien" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableUserMedicineStore()
        {
            ...
            try
            {
                string sql_tbluser = "CREATE TABLE IF NOT EXISTS ie_tbluser_medicinestore( usermestid serial NOT NULL, medicinestoreid integer, medicinestoretype integer, usercode text, userdepgidnote text, CONSTRAINT tools_tbluser_medicinestore_pkey PRIMARY KEY (usermestid) );";
                if (condb.ExecuteNonQuery_HSBA(sql_tbluser))
                {
                    result = true;
                }
            ...
            {
                O2S_InsuranceExpertise.Base.Logging.Error("Lỗi CreateTableUserMedicineStore" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableUserMedicinePhongLuu()
        {
            ...
            try
            {
                string sql_tbluser = "CREATE TABLE IF NOT EXISTS ie_tbluser_medicinephongluu( userphongluutid serial NOT NULL, medicinephongluuid integer, medicinestoreid integer, usercode text, userdepgidnote text, CONSTRAINT tools_tbluser_medicinephongluu_pkey PRIMARY KEY (userphongluutid) );";
                if (condb.ExecuteNonQuery_HSBA(sql_tbluser))
                {
                    result = true;
                }
            ...
            {
                O2S_InsuranceExpertise.Base.Logging.Error("Lỗi CreateTableUserMedicinePhongLuu" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableToolsServicepricePttt()
        {
            ...
            {
                O2S_InsuranceExpertise.Base.Logging.Error("Lỗi CreateTableToolsServicepricePttt" + ex.ToString());
            }
            return result;
        }
        #endregion
        ...
        private static bool CreateFunctionByteaImport()
        {
            ...
            {
                O2S_InsuranceExpertise.Base.Logging.Error("Lỗi CreateFunctionByteaimport" + ex.ToString());
            }
            return result;
        }
