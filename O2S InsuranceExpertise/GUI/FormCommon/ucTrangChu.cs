    ...
    public partial class ucTrangChu : UserControl
    {
        ...
        private void EnablePhanQuyenVaLicense()
        {
            try
            {
                ...
                if (SessionLogin.SessionUsercode != O2S_InsuranceExpertise.Base.KeyTrongPhanMem.AdminUser_key)
                {
                    ...
                    {
                        if (O2S_InsuranceExpertise.Base.CheckPermission.ChkPerModule("SYS_05"))
                        {
                            xtraTabCaiDat.PageVisible = true;
                            navBarItemConnectDB.Visible = O2S_InsuranceExpertise.Base.CheckPermission.ChkPerModule("SYS_01");
                            navBarItemListNguoiDung.Visible = O2S_InsuranceExpertise.Base.CheckPermission.ChkPerModule("SYS_02");
        ...
        private void LoadThongTinCoBan()
        {
            try
            {
                ...
                {
                    linkLabelTenNguoiDung.Text = O2S_InsuranceExpertise.Base.SessionLogin.SessionUsername;
                }
            }
            catch (Exception ex)
            {
