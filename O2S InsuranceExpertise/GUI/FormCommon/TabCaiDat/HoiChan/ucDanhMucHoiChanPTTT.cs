        ...
        void ItemXoaThuocKhoiDS_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    ...
                    {
                        O2S_InsuranceExpertise.Utilities.ThongBao.frmThongBao frmthongbao = new O2S_InsuranceExpertise.Utilities.ThongBao.frmThongBao(Base.ThongBaoLable.XOA_THANH_CONG);
                        frmthongbao.Show();
                        GetDataDanhMucPTTT();
                    }
                }
