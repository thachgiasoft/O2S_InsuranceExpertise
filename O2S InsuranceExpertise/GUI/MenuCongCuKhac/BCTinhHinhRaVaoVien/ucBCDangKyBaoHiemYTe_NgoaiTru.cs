        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (cboTieuChi.Text == "Theo ngày vào viện")
                {
                    ...
                    tieuchi_ie_bhyt_check = " where hosobenhandate between ''" + tungay + "'' and ''" + denngay + "'' ";
                    orderby = " hsba.hosobenhandate ";
                }
                else if (cboTieuChi.Text == "Theo ngày ra viện")
                {
                    tieuchi_hsba = " where hosobenhandate_ravien between '" + tungay + "' and '" + denngay + "' ";
                    tieuchi_ie_bhyt_check = " where vienphidate_ravien between ''" + tungay + "'' and ''" + denngay + "'' ";
