...
using O2S_InsuranceExpertise.Utilities.PrintPreview;
using System;
...
namespace O2S_InsuranceExpertise.GUI.ChucNang.HoiChan
{
    public partial class frmHoiChan_NhapDuLieu : Form
    {
        #region Khai bao
        private int currentloaihoichan { get; set; }
        private InsuranceExpertiseDTO currentInsuranceExpertise { get; set; }
        ...
        public frmHoiChan_NhapDuLieu(int loaihoichan, InsuranceExpertiseDTO rowInsuranceExpertise, MrdHsbaHoiChanDTO rowHsbaHoiChan)
        {
            try
            {
                InitializeComponent();
                this.currentloaihoichan = loaihoichan;
                this.currentInsuranceExpertise = rowInsuranceExpertise;
        ...
        private void LoadControlDefault()
        {
            try
            {
                ...
                if (this.currentInsuranceExpertise.InsuranceExpertisestatus != 2) //BN da ket thuc dieu tri
                {
            ...
            try
            {
                ...
                if (this.currentInsuranceExpertise.departmentgroupname == null || this.currentInsuranceExpertise.departmentgroupname == "")
                {
                    ...
                    if (datakhoa != null && datakhoa.Rows.Count > 0)
                    {
                        ...
                        this.currentInsuranceExpertise.giuong = datakhoa.Rows[0]["giuong"].ToString();
                        this.currentInsuranceExpertise.departmentname = datakhoa.Rows[0]["departmentname"].ToString();
                        this.currentInsuranceExpertise.departmentgroupname = datakhoa.Rows[0]["departmentgroupname"].ToString();
                    }
                }
                else
                {
                    txtHopTai.Text = this.currentInsuranceExpertise.departmentgroupname;
                }
            }
            catch (Exception ex)
            {
        ...
        private void btnLuuLai_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                HsbaHoiChanSave.hosobenhanid = this.currentInsuranceExpertise.hosobenhanid;
                HsbaHoiChanSave.InsuranceExpertiseid = this.currentInsuranceExpertise.InsuranceExpertiseid;
                HsbaHoiChanSave.patientid = this.currentInsuranceExpertise.patientid;
                HsbaHoiChanSave.vienphiid = this.currentInsuranceExpertise.vienphiid;
                HsbaHoiChanSave.departmentgroupid = this.currentInsuranceExpertise.departmentgroupid;
                HsbaHoiChanSave.departmentid = this.currentInsuranceExpertise.departmentid;
                ...
                {
                    O2S_InsuranceExpertise.Utilities.ThongBao.frmThongBao frmthongbao = new O2S_InsuranceExpertise.Utilities.ThongBao.frmThongBao(O2S_InsuranceExpertise.Base.ThongBaoLable.LUU_THANH_CONG);
                    frmthongbao.Show();
                    ...
                    switch (this.currentloaihoichan)
                    {
                        ...
                        case 3: //Hoi chan chuyen vien
                            {
                                layIDhoichan = "select mrd_hsba_hccvienid as mrd_hsba_hcid from mrd_hsba_hccvien where InsuranceExpertiseid=" + this.HsbaHoiChanSave.InsuranceExpertiseid + "; ";
                                break;
                            }
                        default:
                            break;
