...
namespace O2S_InsuranceExpertise.GUI.ChucNang
{
    public partial class ucDSHoSoBenhAn : UserControl
    {
        ...
        #region Load
        private void ucDSHoSoBenhAn_HoiChan_Load(InsuranceExpertiseDTO rowMecicalrecord)
        {
            try
            {
        ...
        private void HoiChan_LoadDataDefault(InsuranceExpertiseDTO rowMecicalrecord)
        {
            try
            {
        ...
        private void HoiChan_LoadThongTinVeHoiChan(InsuranceExpertiseDTO rowMecicalrecord)
        {
            ...
            try
            {
                ...
                string sqllstHoiChan = "select 1 as mrd_loaihc_id, 'Hội chẩn phẫu thuật' as mrd_loaihc_name, mrd_hsba_hcptttid as mrd_hsba_hcid, mrd_dmhc_ptttid as mrd_dmhc_id, 0 as his_chuyenvienid, 0 as medicinerefid_org, maubenhphamid, servicepriceid, servicepricecode, servicepricename, servicepricedate, hosobenhanid, InsuranceExpertiseid, patientid, vienphiid, departmentgroupid, departmentid, thoigianhoichan, yeucauhoichanid, yeucauhoichanname, diadiemhoichan, dbb_tomtattiensubenh, dbb_tinhtranglucvaovien, dbb_chandoantuyenduoi, dbb_tomtatdienbienbenh, yk_chandoantienluong, yk_phuongphapdieutri, yk_chamsoc, kl_ketluan, tvtg_chutoa_code, tvtg_chutoa_ten, tvtg_chutoa_cdcv, tvtg_thuky_code, tvtg_thuky_ten, tvtg_thuky_cdcv, tvtg_thanhvien1_code, tvtg_thanhvien1_ten, tvtg_thanhvien1_cdcv, tvtg_thanhvien2_code, tvtg_thanhvien2_ten, tvtg_thanhvien2_cdcv, tvtg_thanhvien3_code, tvtg_thanhvien3_ten, tvtg_thanhvien3_cdcv, tvtg_thanhvien4_code, tvtg_thanhvien4_ten, tvtg_thanhvien4_cdcv, tvtg_thanhvien5_code, tvtg_thanhvien5_ten, tvtg_thanhvien5_cdcv, tvtg_thanhvien6_code, tvtg_thanhvien6_ten, tvtg_thanhvien6_cdcv, mrd_hsba_hcptttstatus as mrd_hsba_hcstatus, create_mrduserid, create_mrdusercode, create_date from mrd_hsba_hcpttt where hosobenhanid='" + rowMecicalrecord.hosobenhanid + "' union all select 2 as mrd_loaihc_id, 'Hội chẩn thuốc dấu *' as mrd_loaihc_name, mrd_hsba_hcthuocid as mrd_hsba_hcid, mrd_dmhc_thuocid as mrd_dmhc_id, 0 as his_chuyenvienid, medicinerefid_org, maubenhphamid, servicepriceid, servicepricecode, servicepricename, servicepricedate, hosobenhanid, InsuranceExpertiseid, patientid, vienphiid, departmentgroupid, departmentid, thoigianhoichan, yeucauhoichanid, yeucauhoichanname, diadiemhoichan, dbb_tomtattiensubenh, dbb_tinhtranglucvaovien, dbb_chandoantuyenduoi, dbb_tomtatdienbienbenh, yk_chandoantienluong, yk_phuongphapdieutri, yk_chamsoc, kl_ketluan, tvtg_chutoa_code, tvtg_chutoa_ten, tvtg_chutoa_cdcv, tvtg_thuky_code, tvtg_thuky_ten, tvtg_thuky_cdcv, tvtg_thanhvien1_code, tvtg_thanhvien1_ten, tvtg_thanhvien1_cdcv, tvtg_thanhvien2_code, tvtg_thanhvien2_ten, tvtg_thanhvien2_cdcv, tvtg_thanhvien3_code, tvtg_thanhvien3_ten, tvtg_thanhvien3_cdcv, tvtg_thanhvien4_code, tvtg_thanhvien4_ten, tvtg_thanhvien4_cdcv, tvtg_thanhvien5_code, tvtg_thanhvien5_ten, tvtg_thanhvien5_cdcv, tvtg_thanhvien6_code, tvtg_thanhvien6_ten, tvtg_thanhvien6_cdcv, mrd_hsba_hcthuocstatus as mrd_hsba_hcstatus, create_mrduserid, create_mrdusercode, create_date from mrd_hsba_hcthuoc where hosobenhanid='" + rowMecicalrecord.hosobenhanid + "' union all select 3 as mrd_loaihc_id, 'Hội chẩn chuyển viện' as mrd_loaihc_name, mrd_hsba_hccvienid as mrd_hsba_hcid, mrd_dmhc_cvienid as mrd_dmhc_id, his_chuyenvienid, 0 as medicinerefid_org, 0 as maubenhphamid, 0 as servicepriceid, '' as servicepricecode, '' as servicepricename, '' as servicepricedate, hosobenhanid, InsuranceExpertiseid, patientid, vienphiid, departmentgroupid, departmentid, thoigianhoichan, yeucauhoichanid, yeucauhoichanname, diadiemhoichan, dbb_tomtattiensubenh, dbb_tinhtranglucvaovien, dbb_chandoantuyenduoi, dbb_tomtatdienbienbenh, yk_chandoantienluong, yk_phuongphapdieutri, yk_chamsoc, kl_ketluan, tvtg_chutoa_code, tvtg_chutoa_ten, tvtg_chutoa_cdcv, tvtg_thuky_code, tvtg_thuky_ten, tvtg_thuky_cdcv, tvtg_thanhvien1_code, tvtg_thanhvien1_ten, tvtg_thanhvien1_cdcv, tvtg_thanhvien2_code, tvtg_thanhvien2_ten, tvtg_thanhvien2_cdcv, tvtg_thanhvien3_code, tvtg_thanhvien3_ten, tvtg_thanhvien3_cdcv, tvtg_thanhvien4_code, tvtg_thanhvien4_ten, tvtg_thanhvien4_cdcv, tvtg_thanhvien5_code, tvtg_thanhvien5_ten, tvtg_thanhvien5_cdcv, tvtg_thanhvien6_code, tvtg_thanhvien6_ten, tvtg_thanhvien6_cdcv, mrd_hsba_hccvienstatus as mrd_hsba_hcstatus, create_mrduserid, create_mrdusercode, create_date from mrd_hsba_hccvien where hosobenhanid='" + rowMecicalrecord.hosobenhanid + "';";
                ...
                if (this.dataHsbaHoiChan != null && this.dataHsbaHoiChan.Rows.Count > 0)
                {
                    for (int i = 0; i < this.dataHsbaHoiChan.Rows.Count; i++)
                    {
                        ...
                        hsbaHoiChan.InsuranceExpertiseid = Utilities.Util_TypeConvertParse.ToInt64(this.dataHsbaHoiChan.Rows[i]["InsuranceExpertiseid"].ToString());
        ...
        private void HoiChan_KiemTraTaoPhieuHoiChan_PT(InsuranceExpertiseDTO rowMecicalrecord)
        {
            SplashScreenManager.ShowForm(typeof(O2S_InsuranceExpertise.Utilities.ThongBao.WaitForm1));
            try
            {
                if (rowMecicalrecord.InsuranceExpertisestatus == 2) //BN dang dieu tri thi duoc tao
                {
                    lstHsbaHoiChanService_PT = new List<MrdHsbaHoiChan_ServiceDTO>();
                    string sqlHoiChan_PT = "select ROW_NUMBER () OVER (ORDER BY ser.servicepricename) as stt, ser.servicepriceid, ser.InsuranceExpertiseid, ser.vienphiid, ser.hosobenhanid, ser.maubenhphamid, ser.departmentid, ser.departmentgroupid, ser.servicepricecode, ser.servicepricename, ser.servicepricename_bhyt, ser.servicepricename_nuocngoai, ser.servicepricedate, ser.soluong from mrd_dmhc_pttt pt inner join dblink('myconn','select servicepriceid, InsuranceExpertiseid, vienphiid, hosobenhanid, maubenhphamid, departmentid, departmentgroupid, servicepricecode, servicepricename, servicepricename_bhyt, servicepricename_nuocngoai, servicepricedate, soluong FROM serviceprice where hosobenhanid=" + rowMecicalrecord.hosobenhanid + " and bhyt_groupcode in (''06PTTT'',''07KTC'')') AS ser(servicepriceid integer, InsuranceExpertiseid integer, vienphiid integer, hosobenhanid integer, maubenhphamid integer, departmentid integer, departmentgroupid integer, servicepricecode text, servicepricename text, servicepricename_bhyt text, servicepricename_nuocngoai text, servicepricedate timestamp without time zone, soluong double precision) on pt.servicepricecode=ser.servicepricecode;";
        ...
        private void HoiChan_KiemTraTaoPhieuHoiChan_Thuoc(InsuranceExpertiseDTO rowMecicalrecord)
        {
            SplashScreenManager.ShowForm(typeof(O2S_InsuranceExpertise.Utilities.ThongBao.WaitForm1));
            try
            {
                if (rowMecicalrecord.InsuranceExpertisestatus == 2) //BN dang dieu tri thi duoc tao
                {
                    ...
                    string sqlHoiChan_Thuoc = "select ROW_NUMBER () OVER (ORDER BY ser.servicepricename) as stt, pt.medicinerefid, ser.medicinerefid_org, ser.servicepriceid, ser.InsuranceExpertiseid, ser.vienphiid, ser.hosobenhanid, ser.maubenhphamid, ser.departmentid, ser.departmentgroupid, ser.servicepricecode, ser.servicepricename, ser.servicepricename_bhyt, ser.servicepricename_nuocngoai, ser.servicepricedate, ser.soluong from mrd_dmhc_thuoc pt inner join dblink('myconn','select me.medicinerefid_org, ser.servicepriceid, ser.InsuranceExpertiseid, ser.vienphiid, ser.hosobenhanid, ser.maubenhphamid, ser.departmentid, ser.departmentgroupid, ser.servicepricecode, ser.servicepricename, ser.servicepricename_bhyt, ser.servicepricename_nuocngoai, ser.servicepricedate, ser.soluong FROM serviceprice ser inner join (select medicinecode, medicinerefid_org from medicine_ref where datatype=0) me on me.medicinecode=ser.servicepricecode where bhyt_groupcode in (''09TDT'',''091TDTtrongDM'',''092TDTngoaiDM'',''093TDTUngthu'',''094TDTTyle'') and hosobenhanid=" + rowMecicalrecord.hosobenhanid + "') AS ser(medicinerefid_org integer, servicepriceid integer, InsuranceExpertiseid integer, vienphiid integer, hosobenhanid integer, maubenhphamid integer, departmentid integer, departmentgroupid integer, servicepricecode text, servicepricename text, servicepricename_bhyt text, servicepricename_nuocngoai text, servicepricedate timestamp without time zone, soluong double precision) on pt.medicinerefid=ser.medicinerefid_org;";
        ...
        private void HoiChan_KiemTraTaoPhieuHoiChan_CV(InsuranceExpertiseDTO rowMecicalrecord)
        {
            SplashScreenManager.ShowForm(typeof(O2S_InsuranceExpertise.Utilities.ThongBao.WaitForm1));
            try
            {
                string sqlHoiChan_CV = "select InsuranceExpertiseid, patientid, chuyenvienid, thoigianchuyenvien from chuyenvien where InsuranceExpertiseid=" + rowMecicalrecord.InsuranceExpertiseid + ";";
                ...
                if (this.dataHoiChan_CV != null && this.dataHoiChan_CV.Rows.Count > 0)
                {
                    if (this.lstHsbaHoiChan != null && this.lstHsbaHoiChan.Count > 0)
                    {
                        ...
                        {
                            List<MrdHsbaHoiChanDTO> hsba_HoiChan = this.lstHsbaHoiChan.Where(o => o.InsuranceExpertiseid == rowMecicalrecord.InsuranceExpertiseid && o.mrd_loaihc_id == 3).ToList();
        ...
        private void btnHoiChan_ChuyenVien_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                HoiChan.frmHoiChan_NhapDuLieu frmHoiChan = new HoiChan.frmHoiChan_NhapDuLieu(3, this.SelectRowInsuranceExpertise, rowHsbaHoiChan);
        ...
        private void cboHoiChan_ChonDVThuoc_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                if (cboHoiChan_ChonDVThuoc.EditValue != null && this.mrd_loaihc_id != 0)
                {
                    ...
                    HoiChan.frmHoiChan_NhapDuLieu frmHoiChan = new HoiChan.frmHoiChan_NhapDuLieu(this.mrd_loaihc_id, this.SelectRowInsuranceExpertise, rowHsbaHoiChan);
                    frmHoiChan.ShowDialog();
                    ucDSHoSoBenhAn_HoiChan_Load(this.SelectRowInsuranceExpertise);
                }
            }
        ...
        private void repositoryItemButtonHoiChan_Sua_Click(object sender, EventArgs e)
        {
            try
            {
                if (gridViewHoiChanDSHC.RowCount > 0)
                {
                    ...
                    {
                        HoiChan.frmHoiChan_NhapDuLieu frmHoiChan = new HoiChan.frmHoiChan_NhapDuLieu(mrd_loaihc_id, this.SelectRowInsuranceExpertise, rowHsbaHoiChanClick);
                        frmHoiChan.ShowDialog();
                        ucDSHoSoBenhAn_HoiChan_Load(this.SelectRowInsuranceExpertise);
                    }
                }
        ...
        private void PrintTrichBienBanHoiChan_Process(MrdHsbaHoiChanDTO rowHsbaHoiChanClick)
        {
            try
            {
                ...
                using (var dlg = new O2S_InsuranceExpertise.Utilities.PrintPreview.CoolPrintPreviewDialog())
                {
