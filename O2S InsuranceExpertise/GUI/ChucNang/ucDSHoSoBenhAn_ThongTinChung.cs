...
namespace O2S_InsuranceExpertise.GUI.ChucNang
{
    public partial class ucDSHoSoBenhAn : UserControl
    {
        ...
        private void ucDSHoSoBenhAn_ThongTinChung_Load(InsuranceExpertiseDTO rowMecicalrecord)
        {
            try
            {
            ...
            try
            {
                if (rowMecicalrecord.InsuranceExpertiseid != 0 && rowMecicalrecord.hosobenhanid != 0)
                {
                    ...
                    if (dataThongTin.Count > 0)
                    {
                        ...
                        txtInsuranceExpertise.Text = dataThongTin[0]["InsuranceExpertisecode"].ToString();
                        ...
                        //
                        this.SelectRowInsuranceExpertise.departmentname = dataThongTin[0]["departmentname"].ToString(); ;
                        this.SelectRowInsuranceExpertise.departmentgroupname = dataThongTin[0]["departmentgroupname"].ToString();
                        this.SelectRowInsuranceExpertise.giuong = dataThongTin[0]["giuong"].ToString();
